        ...
        <div class="container-fluid ">
            <div class="row ">
                <div class="col-md-12 col-sm-12 bg-dark">
                    <div class="row pt-5">
                        <div class="col-md-9 col-sm-12 py-5 pl-5 ">
                        ...
                        <div class="col-md-3 col-sm-12 bg-dark p">
                            <div class="card mt-5 d-none d-md-block" style="position: absolute; left: 15%;right: 15%;">
                                <div class="content">
                            ...
                            <div class="card mt-5 d-block d-md-none ">
                                <div class="content">
                                    <div class="image" style="height: 250px; background: url(<?php echo base_url('hacked-usa/assets/course/' . $courses->location_folder . '/' . $courses->course_cover) ?>); background-repeat: no-repeat; background-position: center">
                                        &nbsp;
                                    </div>
                                                ...
                                                <ol>
                                                    ...
                                                    foreach ($res as $key => $r) {
                                                        ...
                                                        <li class="d-flex justify-content-between align-items-center">
                                                            <span><?php echo $r->file_name ?></span>
                                                        </li>
                                                    <?php } ?>
                                                </ol>
                                            </ul>
